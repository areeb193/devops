...
// Use a safe fallback and normalize trailing slashes.
const RAW_BASE = import.meta?.env?.VITE_API_BASE_URL || "http://localhost:4000";
// remove whitespace and trailing slashes from the base URL
export const BASE_URL = RAW_BASE.replace(/\s+/g, "").replace(/\/+$/g, "");
